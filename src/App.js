...
function App() {
  ...
  // useEffect(() => {
  //   img = "https://pbs.twimg.com/media/CLDsxyGUMAAgq26.jpg"
  //   console.log("effect")
  // });

  function toggleStory(storyImg) {
    ...
    setStoryImg(curent => storyImg)
    // storyImg = "https://pbs.twimg.com/media/CLDsxyGUMAAgq26.jpg"
